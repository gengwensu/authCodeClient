package com.practice.authcodeclient.config;

import com.practice.authcodeclient.service.OAuth2ClientTokenService;
...
public class ClientConfiguration {
    ...
    public OAuth2RestTemplate oauth2RestTemplate() {
        ...
        provider.setClientTokenServices(oAuth2ClientTokenService);
